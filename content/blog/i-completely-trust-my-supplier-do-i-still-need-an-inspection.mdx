...
When it comes to documenting the most common mistakes that are deliberately made, the substitution for defective materials tops the list. Suppliers don't consider this substitution as malicious or fraudulent - for example, if 600D polyester fabric is not restricted in your Purchase Order, the manufacturer will often assume a substitution is acceptable.
